...
async function seed() {
    ...
    profile = await MentorProfile.create({
      ...
      pricingPlans: [
        ...
        },
        {
          ...
          price: 9999,
          discountPercent: 17,
          features: ['12 sessions', 'Resume review', '2x Mock interview', 'Referral support'],
        },
        {
          duration: '6 Months',
          price: 16999,
      ...
      trialSession: {
        available: true,
        price: 499,
        description: '30-min intro call to assess fit and create a personalised roadmap.',
      },
      sectorType: 'private',
      availabilitySlots: [
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment:
            'Rahul helped me crack SDE-2 at Razorpay in just 6 weeks. His system design sessions are top-notch!',
  ...
  const services = [
    // ── Live Sessions ──────────────────────────────────────────────────────
    {
      ...
      description:
        '30-min no-commitment intro to understand your goals and see if we are a good fit.',
      price: 0,
      isFree: true,
      duration: 30,
    ...
    },
    {
      ...
      description:
        'Deep-dive 60-min live session. DSA problem solving, system design, or code review — you choose the topic.',
      price: 1499,
      isFree: false,
      duration: 60,
    ...
    },
    {
      ...
      description:
        'Rapid fire 15-min call for a specific doubt or quick career advice. Best value for simple questions.',
      price: 399,
      isFree: false,
      duration: 15,
    ...
    },
    {
      ...
      description:
        'Realistic 60-min FAANG-style mock interview followed by detailed written feedback.',
      price: 1999,
      isFree: false,
      duration: 60,
    ...
    },
    {
      ...
      description:
        '45-min session to map out your career path — switching companies, negotiating offers, or transitioning roles.',
      price: 1299,
      isFree: false,
      duration: 45,
    ...
    },
    {
      ...
      description:
        'Structured 6-week program with 12 live 1:1 sessions. From DSA basics to full system design mock interview.',
      price: 14999,
      isFree: false,
      duration: 60,
      sessionCount: 12,
    ...
    // ── Async / On-Demand ──────────────────────────────────────────────────
    {
      ...
      description:
        'Send me unlimited messages for a month. I respond within 24 hours. Best for ongoing job searches.',
      price: 999,
      isFree: false,
    ...
    },
    {
      ...
      description:
        'Upload your resume and get detailed written feedback with edits — formatted for FAANG ATS systems.',
      price: 799,
      isFree: false,
    ...
    },
    {
      ...
      description:
        'Share your GitHub or portfolio URL. I will review code quality, readme standards, and project presentation.',
      price: 599,
      isFree: false,
      responseTime: 'within 48 hours',
      includes: [
        'Code quality review',
        'Project README feedback',
    ...
    },
    {
      ...
      description:
        'Submit one detailed question. I send you a thorough written (or Loom video) response within 48 hours.',
      price: 299,
      isFree: false,
      responseTime: 'within 48 hours',
      includes: [
        'Detailed written answer',
        'Optional Loom video response',
        'Follow-up allowed once',
      ],
      sortOrder: 9,
    },
    ...
    // ── Digital Products ───────────────────────────────────────────────────
    {
      ...
      description:
        'I will refer your profile internally at Google, Atlassian, or Swiggy after a 30-min screening call.',
      price: 2499,
      isFree: false,
      ...
      includes: [
        ...
        'Interview prep tips for that company',
        'Status follow-up',
      ],
      sortOrder: 10,
    },
    {
      ...
      description:
        'Self-paced video course: 80+ hours covering every LeetCode pattern + HLD/LLD for FAANG interviews.',
      price: 4999,
      isFree: false,
    ...
    // ── Group Events ──────────────────────────────────────────────────────
    {
      ...
      description:
        'Live 3-hour interactive workshop (max 20 students). We design 3 real-world systems end-to-end.',
      price: 1499,
      isFree: false,
      duration: 180,
      capacity: 20,
    ...
    },
    {
      ...
      description:
        'Free 90-min live webinar: roadmap to crack top product companies in 2025. Q&A at the end.',
      price: 0,
      isFree: true,
      duration: 90,
      capacity: 200,
    ...
    // ── Custom ──────────────────────────────────────────────────────────────
    {
      ...
      description:
        "Need something that doesn't fit the above? Team training, company workshops, long-term coaching — reach out and we'll scope it.",
      price: 0,
      isFree: true,
  ...
  created.forEach((svc, i) => {
    ...
    lines.push(
      `       Duration : ${svc.duration ? svc.duration + ' min' : svc.responseTime || '—'}`
    );
