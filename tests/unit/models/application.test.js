...
describe('Application Model Tests', () => {
    ...
    describe('Application Creation', () => {
        ...
        it('should generate unique trackingId', async () => {
            const app1 = await Application.create({ ...validApplicationData, email: 'app1@test.com', phone: '1111111111' });
            const app2 = await Application.create({ ...validApplicationData, email: 'app2@test.com', phone: '2222222222' });
    ...
    describe('Status Validation', () => {
        ...
        it('should accept all valid status values', async () => {
            const validStatuses = ['Pending', 'Under Review', 'Approved', 'Rejected', 'More Info Requested'];
    ...
    describe('Instance Methods', () => {
        ...
        describe('requestMoreInfo', () => {
            it('should request more info with details', async () => {
                ...
                expect(updatedApp.moreInfoRequest.requestDetails).toBe('Please provide your certifications');
    ...
    describe('Availability Slots', () => {
        ...
        it('should validate day enum in availability slots', async () => {
            const app = new Application({
                ...
                phone: '8888888888',
                availabilitySlots: [
                    { day: 'InvalidDay', startTime: '09:00', endTime: '17:00' },
                ],
            });
        ...
        it('should handle education array', async () => {
            const app = await Application.create({
                ...
                education: [
                    ...
                    { degree: 'M.Tech', field: 'Software Engineering', institution: 'IIT Bombay', year: 2017 },
                ],
            });
