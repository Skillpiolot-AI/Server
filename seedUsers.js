...
const userData = [
  { name: 'Ravi Gupta',    username: 'ravi_gupta',    email: 'ravi.gupta@user.dev',    password: 'User@1234' },
  { name: 'Pooja Verma',   username: 'pooja_verma',   email: 'pooja.verma@user.dev',   password: 'User@1234' },
  { name: 'Akash Tiwari',  username: 'akash_tiwari',  email: 'akash.tiwari@user.dev',  password: 'User@1234' },
  { name: 'Neha Malhotra', username: 'neha_malhotra', email: 'neha.malhotra@user.dev', password: 'User@1234' },
  { name: 'Siddharth Das', username: 'siddharth_das', email: 'siddharth.das@user.dev', password: 'User@1234' },
  { name: 'Kavita Pandey', username: 'kavita_pandey', email: 'kavita.pandey@user.dev', password: 'User@1234' },
  { name: 'Amit Saxena',   username: 'amit_saxena',   email: 'amit.saxena@user.dev',   password: 'User@1234' },
  { name: 'Rekha Mishra',  username: 'rekha_mishra',  email: 'rekha.mishra@user.dev',  password: 'User@1234' },
  { name: 'Nikhil Jain',   username: 'nikhil_jain',   email: 'nikhil.jain@user.dev',   password: 'User@1234' },
  { name: 'Swati Yadav',   username: 'swati_yadav',   email: 'swati.yadav@user.dev',   password: 'User@1234' },
];
...
async function seed() {
  ...
  line(`Permissions: ALL (manage_teachers, manage_students, view_reports, manage_courses, manage_library, manage_fees)`);
  ...
  for (let i = 0; i < mentorData.length; i++) {
    ...
    const mentorProfile = await MentorProfile.create({
      ...
      pricingType    : 'paid',
      pricingPlans   : [
        { duration: '1 Month',  price: 2999, discountPercent: 0,  features: ['4 sessions', 'Resume review', 'Mock interview'] },
        { duration: '3 Months', price: 7999, discountPercent: 11, features: ['12 sessions', 'Resume review', 'Mock interview', 'Referral support'] },
        { duration: '6 Months', price: 14999, discountPercent: 17, features: ['24 sessions', 'Resume review', 'Mock interview', 'Referral support', 'Job application tracking'] },
      ],
